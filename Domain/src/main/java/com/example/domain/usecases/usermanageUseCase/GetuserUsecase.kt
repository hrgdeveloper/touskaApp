...
class GetuserUsecase @Inject constructor(val userManageRepository: UserManageRepository) {

    operator fun invoke(qrCode:String) : Flow<Resource<UserManage>> {
        return userManageRepository.getUser(qrCode)
    }
