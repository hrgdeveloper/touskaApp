...
class CreatePostUsecase @Inject constructor(val postRepository: PostRepository) {

    operator fun invoke(title:String) : Flow<Resource<Post>> {
        return postRepository.addPost(title)
    }
