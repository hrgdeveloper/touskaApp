...
class ActivityviewModel @Inject constructor(
    ...
    private val activities_ = MutableLiveData<Resource<MutableList<Activity>>>()
    val activities: LiveData<Resource<MutableList<Activity>>> get() = activities_
    ...
    fun getActivities(postId:Int) {
        viewModelScope.launch {
            getActivityUsecase(postId).collect {
                activities_.postValue(it)
            }
        }
    }
